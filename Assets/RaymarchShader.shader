        ...
        Pass
        {
            ...
            float distanceField(float3 p)
            {
                ...
                //return opU(box1, sphere1);
                 ...
                 //sdMengerCyl(in float3 p, float b, int _iterations, float3 _modOffsetPos, float _smoothRadius, float _scaleFactor)
                float2 Menger1 = sdMenger(p - _box1.xyz , _box1.w , 5 , float3(1, 1, 1), 0, 1.0);
                return Menger1;
            }
