...
//mergerSponge
float2 sdMenger( in float3 p, float b, int _iterations, float3 _modOffsetPos ,  float _smoothRadius, float _scaleFactor)
{
...
float2 sdMengerCyl( in float3 p, float b, int _iterations, float3 _modOffsetPos, float _smoothRadius, float _scaleFactor) //, float4x4 _iterationTransform
{  
